...
type GetInfoClient interface {
	ReturnInfo(ctx context.Context, in *RequestId, opts ...grpc.CallOption) (*InfoReply, error)
}
...
func (c *getInfoClient) ReturnInfo(ctx context.Context, in *RequestId, opts ...grpc.CallOption) (*InfoReply, error) {
	out := new(InfoReply)
...
type GetInfoServer interface {
	ReturnInfo(context.Context, *RequestId) (*InfoReply, error)
...
func (UnimplementedGetInfoServer) ReturnInfo(context.Context, *RequestId) (*InfoReply, error) {
...
var GetInfo_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "confproto/config.proto",
}
